    ...
    return (
        <motion.section
            ...
            <main className="absolute inset-0 w-full h-full overflow-hidden rounded-xl">
                ...
                <article className="absolute inset-0 flex flex-col justify-end p-6 lg:p-8 text-white">
                    <Opacity delay={index * 0.05} className="space-y-2 lg:space-y-4">
                        <h3 className="text-base sm:text-lg 2xl:text-xl font-bold leading-tight line-clamp-2 font-heading">
                            {JSON.parse(project.title)[locale]}
                        </h3>

                        <p className="text-xs lg:text-sm text-white/80 line-clamp-2 font-body">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex h-8 lg:h-10 w-8 lg:w-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm border border-gray-200/20">
                                <ArrowRight className="h-4 lg:h-5 w-4 lg:w-5 text-white group-hover:text-white transition-colors" />
                            </div>
                        </div>
                    </Opacity>
                </article>
