...
export default function CarouselButtons() {
    return (
        <>
            ...
            >
                <div className='absolute left-[55%] top-[50%] -translate-1/2 scale-200 group-hover:scale-125 -rotate-[90deg] cursor-pointer transition-all duration-500 brightness-[12]'>
