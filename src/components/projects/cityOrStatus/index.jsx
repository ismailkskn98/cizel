                            ...
                            return (
                                ...
                                >
                                    <div className="relative h-64 overflow-hidden bg-gray-100">
                                        ...
                                        {project.projectStatus && (
                                            <div className="absolute top-4 left-4">
                                                <span className="px-3 py-1.5 text-xss sm:text-xs font-medium bg-white/95 text-gray-800 rounded-full shadow-lg backdrop-blur-sm">
                                                    {project.projectStatus}
                                                </span>
                                            </div>
                                        )}
                                        ...
                                        {jobTypes.length > 0 && (
                                            <div className="absolute top-4 right-4 flex flex-wrap gap-1.5 justify-end max-w-[60%]">
                                                {jobTypes.map((type, idx) => (
                                                    <span
                                                        key={idx}
                                                        className="px-2.5 py-1 text-[10px] font-medium bg-logo-red text-white rounded-full shadow-lg"
                                                    >
                                                        {type}
                                                    </span>
                                                ))}
                                    ...
                                    <div className="p-6 space-y-2 sm:space-y-4">
                                        <h3 className="text-base lg:text-lg 2xl:text-xl font-medium text-gray-900 line-clamp-2 leading-tight group-hover:text-logo-red transition-colors duration-300">
                                            {project.title}
                                        </h3>
                                        ...
                                        <div className="grid grid-cols-2 gap-3 text-sm">
                                            {project.location && (
                                                <div className="flex items-center gap-1 lg:gap-2">
                                                    ...
                                                    <span className="text-gray-600 font-medium text-xs md:text-sm">{project.location}</span>
                                                </div>
                                            )}
                                            ...
                                            {project.year && (
                                                <div className="flex items-center gap-1 lg:gap-2">
                                                    ...
                                                    <span className="text-gray-600 font-medium text-xs md:text-sm">{project.year}</span>
                                                </div>
                                            )}
                                        </div>
