            ...
            <Opacity>
                <section className="text-center lg:text-left">
                    <article className="space-y-3">
                        <article className="flex flex-col lg:flex-row items-center gap-2 mb-6">
                            <div className="relative">
                                ...
                                <div className="w-5 md:w-7 xl:w-10 h-5 md:h-7 xl:h-10 bg-black rounded-full" />
                            </div>
                            <span className="inline-block text-xs lg:text-sm 3xl:text-base font-medium text-black/80 ml-0 mt-14 lg:mt-0 lg:ml-16 xl:ml-20">{t("badge")}</span>
                        </article>
