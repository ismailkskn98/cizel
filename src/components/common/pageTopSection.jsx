...
export default function PageTopSection({ breadcrumbs }) {
    return (
        <section className="fluid p-2 relative z-40 mt-[-6rem] h-80 w-full overflow-hidden">
            <div className="relative flex items-center justify-center bg-gradient-to-b from-black to-[#2b2b2b] w-full h-full rounded-3xl overflow-hidden">
                ...
                <Image
                    ...
                    width={200}
                    height={200}
                    className='absolute left-0 bottom-[-2px] w-fit h-96 brightness-[12] opacity-[0.02]'
                />
                <Image
                    ...
                    width={200}
                    height={200}
                    className='absolute right-0 bottom-[-2px] w-fit h-96 brightness-[12] opacity-[0.02]'
                />
