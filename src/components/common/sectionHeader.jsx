...
export default function SectionHeader({
    ...
    descriptionClassName = "text-sm lg:text-lg xl:text-xl text-muted-foreground max-w-3xl mx-auto font-body leading-relaxed",
    showDivider = true,
    dividerClassName = "w-32 h-1 bg-gradient-to-r from-logo-red to-secondary mx-auto mb-6"
}) {
    return (
        <FadeIn className={`text-center mb-8 lg:mb-20 ${className}`}>
