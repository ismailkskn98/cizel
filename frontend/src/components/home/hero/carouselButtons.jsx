    ...
    return (
        <>
            <button
                ...
                className="hidden md:inline-block w-16 h-16 group absolute left-6 top-1/2 z-20 -translate-y-1/2 rounded-full border border-white/50 hover:border-logo-red/70 transition !cursor-pointer"
            >
                <div className='absolute left-[55%] top-[50%] -translate-1/2 scale-[150%] group-hover:scale-125 -rotate-[90deg] brightness-[12] group-hover:brightness-[1] cursor-pointer transition-all duration-500'>
            ...
            <button
                ...
                className="hidden md:inline-block w-16 h-16 group absolute right-6 top-1/2 z-20 -translate-y-1/2 rounded-full border border-white/50 hover:border-logo-red/70 transition !cursor-pointer"
            >
                <div className='absolute left-[55%] top-[50%] -translate-1/2 scale-[150%] group-hover:scale-125 rotate-[90deg] brightness-[12] group-hover:brightness-[1] cursor-pointer transition-all duration-500'>
